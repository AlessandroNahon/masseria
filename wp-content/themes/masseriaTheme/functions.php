...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    ...
    get_template_directory_uri() . '/node_modules/mobile-detect/mobile-detect.js', //source
    false, //dependencies
    null, // version number
    true //load in footer
  );
  ...
  wp_enqueue_script(
    'scrollreveal', //handle
    get_template_directory_uri() . '/node_modules/scrollreveal/src/scrollreveal.js', //source
    false, //dependencies
    null, // version number
    true //load in footer
  );
  ...
  wp_enqueue_script(
    'threejs', //handle
    get_template_directory_uri() . '/js/three.js', //source
    false, //dependencies
    null, // version number
    true //load in footer
  );
