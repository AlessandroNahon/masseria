	...
	function widget( $args, $instance ) {
		...
		<div>
			<form class="es_widget_form" es_form_id="es_widget_form">
				...
				<div class="es_textbox">
					<input type="text"  placeholder="Email address" id="es_txt_email" class="es_textbox_class" name="es_txt_email" onkeypress="if(event.keyCode==13) es_submit_page(event,'<?php echo $url; ?>')" value="" maxlength="225">
				</div>
				<div class="es_button">
